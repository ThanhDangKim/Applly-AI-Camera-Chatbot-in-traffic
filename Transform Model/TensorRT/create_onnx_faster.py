...
class DET2GraphSurgeon:
    def __init__(self, saved_model_path, config_file, weights):
        ...
        self.first_NMS_score_threshold = 0.001
        # self.first_NMS_score_threshold = self.det2_cfg.MODEL.RPN.NMS_THRESH
    ...
    def get_anchors(self, sample_image):
        ...
        # imagelist_images = ImageList.from_tensors(images, 640)
    ...
    def save(self, output_path):
        ...
        # 🛠️ Bổ sung dòng này để infer shape trước khi lưu
        model = shape_inference.infer_shapes(model)
