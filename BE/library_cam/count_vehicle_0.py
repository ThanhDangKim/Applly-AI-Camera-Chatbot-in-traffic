...
class Cam0Config:
    def __init__(self, source_path="./Data_video/Cam_0/test_faster.mp4"):
        # === DeepSORT tracker ===
        ...
        rect_w, rect_h = int(self.frame_width * 0.86), int(self.frame_height * 0.86)
        self.polygon = np.array([
            [center_x - rect_w // 2, center_y - rect_h // 2],
            [center_x + rect_w // 2 + int(self.frame_width * 0.08), center_y - rect_h // 2],
            [center_x + rect_w // 2 + int(self.frame_width * 0.08), center_y + rect_h // 2],
            [center_x - rect_w // 2, center_y + rect_h // 2]
        ])
        ...
        self.direction_zones = {
            "top": [
                (int(self.frame_width * 0.0367), int(self.frame_height * 0.178)),
                (int(self.frame_width * 0.6776), int(self.frame_height * 0.178)),
                (int(self.frame_width * 0.677), int(self.frame_height * 0.50)),
                (int(self.frame_width * 0.0367), int(self.frame_height * 0.50))
            ],
            "bottom": [
                (int(self.frame_width * 0.0), int(self.frame_height * 0.75)),
                (int(self.frame_width * 0.749), int(self.frame_height * 0.75)),
                (int(self.frame_width * 0.749), int(self.frame_height * 1.0)),
                (int(self.frame_width * 0.0), int(self.frame_height * 1.0))
            ],
            "left": [
                (int(self.frame_width * 0.0), int(self.frame_height * 0.26)),
                (int(self.frame_width * 0.10), int(self.frame_height * 0.26)),
                (int(self.frame_width * 0.10), int(self.frame_height * 0.748)),
                (int(self.frame_width * 0.0), int(self.frame_height * 0.748))
            ],
            "right": [
                (int(self.frame_width * 0.85), int(self.frame_height * 0.32)),
                (int(self.frame_width * 1.0), int(self.frame_height * 0.32)),
                (int(self.frame_width * 1.0), int(self.frame_height * 1.0)),
                (int(self.frame_width * 0.85), int(self.frame_height * 1.0))
            ]
        }
        self.tb = 57
        self.lr = 27
        ...
        self.mpp = 0.022  # meters per pixel
        ...
        self.VTw_dict = {"top": 3.2, "bottom": 3.8, "left": 3.8, "right": 3.1}  # Green time
        self.VTL_dict = {"top": 4.7, "bottom": 2.1, "left": 2.9, "right": 3.2}  # Red time
        self.green_time = 0 
        self.yellow_time = 0
    ...
    def get_zones(self):
        zones = [
            ("Far", 
            (int(self.frame_width * 0.11), 0),
            (int(self.frame_width), 0),
            (int(self.frame_width * 0.11), int(self.frame_height * 0.42)),
            (int(self.frame_width), int(self.frame_height * 0.42)),
            (255, 0, 0)),  # Blue

            ("Near", 
            (int(self.frame_width * 0), int(self.frame_height * 0.61)),
            (int(self.frame_width), int(self.frame_height * 0.61)),
            (int(self.frame_width * 0), self.frame_height),
            (int(self.frame_width), self.frame_height),
            (0, 255, 0)),  # Green

            ("Near Lane 1", 
            (int(self.frame_width * 0.26), int(self.frame_height * 0.61)),
            (int(self.frame_width * 0.41), int(self.frame_height * 0.61)),
            (int(self.frame_width * 0.09), int(self.frame_height * 0.79)),
            (int(self.frame_width * 0.27), int(self.frame_height * 0.79)),
            (0, 255, 128)),  

            ("Top Center", 
            (int(self.frame_width * 0.17), int(self.frame_height * 0.42)),
            (int(self.frame_width * 1.0), int(self.frame_height * 0.42)),
            (int(self.frame_width * 0.17), int(self.frame_height * 0.52)),
            (int(self.frame_width * 1.0), int(self.frame_height * 0.52)),
            (0, 255, 255)),  # Yellow

            ("Top Center Left", 
            (int(self.frame_width * 0.20), int(self.frame_height * 0.42)),
            (int(self.frame_width * 0.23), int(self.frame_height * 0.42)),
            (int(self.frame_width * 0.12), int(self.frame_height * 0.49)),
            (int(self.frame_width * 0.17), int(self.frame_height * 0.49)),
            (128, 255, 255)),  # Yellow

            ("Center", 
            (int(self.frame_width * 0.18), int(self.frame_height * 0.52)),
            (int(self.frame_width * 1.0), int(self.frame_height * 0.52)),
            (int(self.frame_width * 0.18), int(self.frame_height * 0.61)),
            (int(self.frame_width * 1.0), int(self.frame_height * 0.61)),
            (255, 255, 0)),  # Cyan

            ("Lane1", 
            (int(self.frame_width * 0.48), int(self.frame_height * 0.42)),
            (int(self.frame_width * 0.58), int(self.frame_height * 0.42)),
            (int(self.frame_width * 0.35), int(self.frame_height * 0.57)),
            (int(self.frame_width * 0.45), int(self.frame_height * 0.57)),
            (128, 0, 128)),  # Purple

            ("Left", 
            (int(self.frame_width * 0.0), int(self.frame_height * 0.51)),
            (int(self.frame_width * 0.18), int(self.frame_height * 0.51)),
            (int(self.frame_width * 0.0), int(self.frame_height * 0.78)),
            (int(self.frame_width * 0.18), int(self.frame_height * 0.78)),
            (0, 0, 255)),  # Red
        ]
        return zones
    ...
    def is_in_far_zone(self, center, zone):
        x, y = center
        _, tl, tr, bl, br, _ = zone

        # đơn giản hóa: kiểm tra theo hình chữ nhật nằm ngang
        if bl[0] <= x <= tr[0] and tl[1] <= y <= bl[1]:
            self.logger.info("1. Far")
            return True
        return False

    def is_in_near_zone(self, center, zone):
        x, y = center
        _, tl, tr, bl, br, _ = zone

        # đơn giản hóa: kiểm tra theo hình chữ nhật nằm ngang
        if tl[0] <= x <= tr[0] and tl[1] <= y <= bl[1]:
            self.logger.info("2. Near")
            return True
        return False

    def is_in_lane1_near_zone(self, center, zone):
        x, y = center
        _, tl, tr, bl, br, _ = zone
    ...
    def is_in_top_center_zone(self, center, zone):
        x, y = center
        _, tl, tr, bl, br, _ = zone

        # đơn giản hóa: kiểm tra theo hình chữ nhật nằm ngang
        if tl[0] <= x <= tr[0] and tl[1] <= y <= bl[1]:
            self.logger.info("4. Top_Center")
            return True
        return False

    def is_in_top_center_left_zone(self, center, zone):
        x, y = center
        _, tl, tr, bl, br, _ = zone

        # đơn giản hóa: kiểm tra theo hình chữ nhật nằm ngang
        if bl[0] <= x <= tr[0] and tl[1] <= y <= bl[1]:
            self.logger.info("3. Top Center Left")
            return True
        return False
    ...
    def is_in_center_zone(self, center, zone):
        ...
        # đơn giản hóa: kiểm tra theo hình chữ nhật nằm ngang
        if tl[0] <= x <= tr[0] and tl[1] <= y <= bl[1]:
            self.logger.info("3. Center")
            return True
        return False
    
    def is_in_lane1_center_zone(self, center, zone):
        x, y = center
        _, tl, tr, bl, br, _ = zone

        # đơn giản hóa: kiểm tra theo hình chữ nhật nằm ngang
        if bl[0] <= x <= tr[0] and tl[1] <= y <= bl[1]:
            self.logger.info("3. Center Lane 1")
            return True
        return False
    
    def is_in_left_zone(self, center, zone):
        x, y = center
        _, tl, tr, bl, br, _ = zone

        # đơn giản hóa: kiểm tra theo hình chữ nhật nằm ngang
        if tl[0] <= x <= tr[0] and tl[1] <= y <= bl[1]:
            self.logger.info("4. Left")
            return True
        return False
    ...
    def calculate_speed_MPP(self, coordinates, bbox_list, fps, frame_width, frame_height, mpp, matrix):
        ...
        mpp_scaled = 0
        # Scale theo vùng
        if self.is_in_far_zone(center, self.zones[0]) == True:
            block_parameter = self.adjust_speed_by_position(center[1], frame_height, 0.3)
            ...
            mpp = mpp * 13.1
            mpp_scaled = mpp * scale_factor * block_parameter

        elif (self.is_in_left_zone(center, self.zones[7]) == True):
            block_parameter = self.adjust_speed_by_position(center[1], frame_height, 3.4)
            self.logger.info(f"BP: {block_parameter}")
        ...
        elif (self.is_in_near_zone(center, self.zones[1]) == True):
            block_parameter = self.adjust_speed_by_position(center[1], frame_height, 2.15)
            self.logger.info(f"BP: {block_parameter}")

            real_height = 1.8
            if (self.is_in_lane1_near_zone(center, self.zones[2]) == True):
                mpp = 8.3
                scale_factor = real_height / (bbox_height * mpp + 1e-6)  # tránh chia 0
                mpp = mpp * 2.1
                mpp_scaled = mpp * scale_factor * ratio * block_parameter
        ...
        elif (self.is_in_center_zone(center, self.zones[5]) == True):
            block_parameter = self.adjust_speed_by_position(center[1], frame_height, 10.5)
            self.logger.info(f"BP: {block_parameter}")

            # scale theo chiều cao bbox, giả định chiều cao thực tế là 1.5m
            if (self.is_in_lane1_center_zone(center, self.zones[6]) == True):
                mpp = 0.0233
                mpp_scaled = ratio * mpp * block_parameter
            else:
                mpp_scaled = ratio * mpp * block_parameter

        elif (self.is_in_top_center_zone(center, self.zones[3]) == True):
            block_parameter = self.adjust_speed_by_position(center[1], frame_height, 14.2)
            self.logger.info(f"BP: {block_parameter}")

            if (self.is_in_lane1_center_zone(center, self.zones[6]) == True):
                mpp = 0.0404
                mpp_scaled = ratio * mpp * block_parameter
            elif (self.is_in_top_center_left_zone(center, self.zones[4]) == True):
                mpp = 0.0153
                mpp_scaled = ratio * mpp * block_parameter
            else:
                mpp_scaled = ratio * mpp * block_parameter
    ...
    def get_adjusted_direction(self, history, direction_zones, threshold=0.05):
        ...
        if (zone == "top" and vector_dir == "left-bottom") or (zone == "top" and vector_dir == "right-bottom") or (zone == "top" and vector_dir == "bottom"):
            return "top"
        if (zone == "right" and vector_dir == "left-top") or (zone == "right" and vector_dir == "left-bottom") or (zone == "right" and vector_dir == "left") or (zone == "top" and vector_dir == "left-top") or (zone == "top" and vector_dir == "left"):
            return "right"
        if (zone == "bottom" and vector_dir == "left-top") or (zone == "bottom" and vector_dir == "right-top") or (zone == "bottom" and vector_dir == "top") or (zone == "right" and vector_dir == "right-top"):
            return "bottom"
        if (zone == "left" and vector_dir == "right-top") or (zone == "left" and vector_dir == "right-bottom") or (zone == "left" and vector_dir == "right") or (zone == "bottom" and vector_dir == "right-bottom") or (zone == "bottom" and vector_dir == "right"):
            return "left"
        else:
    ...
    def calculate_light_times(self, direction_counts_snapshot, direction_speeds_snapshot, 
        ...
        for key in keys:
            ...
            print(f"Mật độ giao thông: {traffic_level}")
    ...
    def check_zone(self, center):
        if (self.is_in_center_zone(center, self.zones[5]) == True) or (self.is_in_left_zone(center, self.zones[7]) == True) or (self.is_in_near_zone(center, self.zones[1]) == True) or (self.is_in_top_center_zone(center, self.zones[3]) == True):
            return True
        else:
            return False
