...
class Cam5Config:
    def __init__(self, source_path="./Data_video/Cam_5/test_faster.mp4"):
        # === DeepSORT tracker ===
        ...
        self.direction_zones = {
            "bottom": [
                (int(self.frame_width * 0.14), int(self.frame_height * 0.15)),
                (int(self.frame_width * 0.90), int(self.frame_height * 0.15)),
                (int(self.frame_width * 0.90), int(self.frame_height * 0.90)),
                (int(self.frame_width * 0.0), int(self.frame_height * 0.90))
            ],
            "top": [(0, 0)] * 4,
            "right": [(0, 0)] * 4
        }
        ...
        self.VTw_dict = {"top": 3.2, "bottom": 2.8, "right": 2.1}  # Green time
        self.VTL_dict = {"top": 1.7, "bottom": 2.1, "right": 1.2}  # Red time
        self.green_time = 0 
        self.yellow_time = 0
    ...
    def get_zones(self):
        zones = [
            ("Lane1", 
            (int(self.frame_width * 0.00), int(self.frame_height * 0.26)),
            (int(self.frame_width * 0.39), int(self.frame_height * 0.26)),
            (int(self.frame_width * 0.0), int(self.frame_height * 0.85)),
            (int(self.frame_width * 0.43), int(self.frame_height * 0.85)),
            (128, 255, 255)),  # Yellow

            ("Lane2", 
            (int(self.frame_width * 0.44), int(self.frame_height * 0.33)),
            (int(self.frame_width * 0.59), int(self.frame_height * 0.33)),
            (int(self.frame_width * 0.44), int(self.frame_height * 0.58)),
            (int(self.frame_width * 0.59), int(self.frame_height * 0.58)),
            (255, 255, 0)),  # Cyan

            ("Lane3", 
            (int(self.frame_width * 0.68), int(self.frame_height * 0.33)),
            (int(self.frame_width * 0.82), int(self.frame_height * 0.33)),
            (int(self.frame_width * 0.68), int(self.frame_height * 0.58)),
            (int(self.frame_width * 0.82), int(self.frame_height * 0.58)),
            (128, 0, 128)),  # Purple

            ("Lane4", 
            (int(self.frame_width * 0.57), int(self.frame_height * 0.58)),
            (int(self.frame_width * 0.81), int(self.frame_height * 0.58)),
            (int(self.frame_width * 0.57), int(self.frame_height * 0.85)),
            (int(self.frame_width * 0.81), int(self.frame_height * 0.85)),
            (128, 255, 128)),  # Purple

            ("Lane5", 
            (int(self.frame_width * 0.82), int(self.frame_height * 0.33)),
            (int(self.frame_width * 0.99), int(self.frame_height * 0.33)),
            (int(self.frame_width * 0.82), int(self.frame_height * 0.46)),
            (int(self.frame_width * 0.99), int(self.frame_height * 0.46)),
            (0, 255, 0)),  # Green

            ("Right_Lane1", 
            (int(self.frame_width * 0.22), int(self.frame_height * 0.40)),
            (int(self.frame_width * 0.26), int(self.frame_height * 0.40)),
            (int(self.frame_width * 0.22), int(self.frame_height * 0.41)),
            (int(self.frame_width * 0.26), int(self.frame_height * 0.41)),
            (0, 255, 128)), 

            ("High_Lane3", 
            (int(self.frame_width * 0.76), int(self.frame_height * 0.44)),
            (int(self.frame_width * 0.789), int(self.frame_height * 0.44)),
            (int(self.frame_width * 0.76), int(self.frame_height * 0.51)),
            (int(self.frame_width * 0.789), int(self.frame_height * 0.51)),
            (128, 0, 128)),  # Purple

            ("High_Lane5", 
            (int(self.frame_width * 0.86), int(self.frame_height * 0.34)),
            (int(self.frame_width * 0.90), int(self.frame_height * 0.34)),
            (int(self.frame_width * 0.86), int(self.frame_height * 0.46)),
            (int(self.frame_width * 0.90), int(self.frame_height * 0.46)),
            (0, 255, 0)), 
    ...
    def is_in_right_lane1_zone(self, center, zone):
        x, y = center
        _, tl, tr, bl, br, _ = zone
    ...
    def calculate_speed_MPP(self, coordinates, bbox_list, fps, frame_width, frame_height, mpp, matrix):
        ...
        if self.is_in_lane1_zone(center, self.zones[0]) == True:
            block_parameter = self.adjust_speed_by_position(center[1], frame_height, 54.3)
            ...
            if self.is_in_right_lane1_zone(center, self.zones[5]) == True:
                mpp = mpp * 0.23
            ...
            block_parameter = self.adjust_speed_by_position(center[1], frame_height, 6.8, 1.5)
            self.logger.info(f"BP: {block_parameter}")
            ...
            block_parameter = self.adjust_speed_by_position(center[1], frame_height, 31.3)
            self.logger.info(f"BP: {block_parameter}")
            ...
            block_parameter = self.adjust_speed_by_position(center[1], frame_height, 43.8, 2)
            self.logger.info(f"BP: {block_parameter}")
            ...
            mpp = 0.986
            scale_factor = real_height / (bbox_height * mpp + 1e-6)  # tránh chia 0
            if (self.is_in_high_lane3_zone(center, self.zones[5]) == True):
                mpp = mpp * 0.90
            else:
                mpp = mpp * 0.325
            mpp_scaled = mpp * ratio * scale_factor * block_parameter
            ...
            block_parameter = self.adjust_speed_by_position(center[1], frame_height, 9.3, 1)
            self.logger.info(f"BP: {block_parameter}")

            real_height = 3.0
            mpp = 0.31
            scale_factor = real_height / (bbox_height * mpp + 1e-6)  # tránh chia 0
            if (self.is_in_high_lane5_zone(center, self.zones[6]) == True):
                mpp = mpp * 0.87
            else:
                mpp = mpp * 0.49
            mpp_scaled = mpp * ratio * scale_factor * block_parameter
    ...
    def calculate_light_times(self, direction_counts_snapshot, direction_speeds_snapshot, 
        ...
        red_light_time = green_light_time + yellow_light_time + 1.1 * VTL_opp_avg
    ...
    def check_zone(self, center):
        if (self.is_in_lane1_zone(center, self.zones[0]) == True) or (self.is_in_lane2_zone(center, self.zones[1]) == True) or (self.is_in_lane3_zone(center, self.zones[2]) == True) or (self.is_in_lane4_zone(center, self.zones[3]) == True) or (self.is_in_lane5_zone(center, self.zones[4]) == True):
            return True
        else:
            return False
