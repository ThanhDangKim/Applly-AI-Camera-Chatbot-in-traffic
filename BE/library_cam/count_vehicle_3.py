...
class Cam3Config:
    def __init__(self, source_path="./Data_video/Cam_3/test_faster.mp4"):
        # === DeepSORT tracker ===
        ...
        self.polygon = np.array([
            [center_x - rect_w // 2, center_y - rect_h // 2 + int(0.29 * self.frame_height)],
            [center_x + rect_w // 2, center_y - rect_h // 2 + int(0.29 * self.frame_height)],
        ...
        self.direction_zones = {
            "top": [
                (int(self.frame_width * 0.24), int(self.frame_height * 0.35)),
                (int(self.frame_width * 0.75), int(self.frame_height * 0.35)),
                (int(self.frame_width * 0.85), int(self.frame_height * 0.70)),
                (int(self.frame_width * 0.0), int(self.frame_height * 0.70))
            ],
            "bottom": [
                (int(self.frame_width * 0.70), int(self.frame_height * 0.30)),
                (int(self.frame_width * 0.99), int(self.frame_height * 0.27)),
                (int(self.frame_width * 0.99), int(self.frame_height * 0.85)),
                (int(self.frame_width * 0.89), int(self.frame_height * 0.77))
            ],
            "right": [
                (int(self.frame_width * 0.47), int(self.frame_height * 0.45)),
                (int(self.frame_width * 0.54), int(self.frame_height * 0.45)),
                (int(self.frame_width * 0.49), int(self.frame_height * 0.99)),
                (int(self.frame_width * 0.38), int(self.frame_height * 0.99))
            ]
        }
        self.tb = 40
        self.lr = 40
        ...
        self.VTw_dict = {"top": 3.1, "bottom": 3.3, "right": 3.0}  # Green time
        self.VTL_dict = {"top": 2.4, "bottom": 3.7, "right": 2.2}  # Red time
        self.green_time = 0 
        self.yellow_time = 0
    ...
    def get_zones(self):
        zones = [
            ("Lane1", 
            (int(self.frame_width * 0.24), int(self.frame_height * 0.478)),
            (int(self.frame_width * 0.39), int(self.frame_height * 0.478)),
            (int(self.frame_width * 0.0), int(self.frame_height * 0.77)),
            (int(self.frame_width * 0.26), int(self.frame_height * 0.85)),
            (128, 255, 255)),  # Yellow

            ("Lane2", 
            (int(self.frame_width * 0.39), int(self.frame_height * 0.478)),
            (int(self.frame_width * 0.54), int(self.frame_height * 0.478)),
            (int(self.frame_width * 0.26), int(self.frame_height * 0.82)),
            (int(self.frame_width * 0.48), int(self.frame_height * 0.85)),
            (255, 255, 0)),  # Cyan

            ("Lane3", 
            (int(self.frame_width * 0.45), int(self.frame_height * 0.478)),
            (int(self.frame_width * 0.65), int(self.frame_height * 0.478)),
            (int(self.frame_width * 0.50), int(self.frame_height * 0.51)),
            (int(self.frame_width * 0.80), int(self.frame_height * 0.51)),
            (128, 0, 128)),  # Purple

            ("Lane4", 
            (int(self.frame_width * 0.45), int(self.frame_height * 0.50)),
            (int(self.frame_width * 0.72), int(self.frame_height * 0.50)),
            (int(self.frame_width * 0.72), int(self.frame_height * 0.82)),
            (int(self.frame_width * 0.84), int(self.frame_height * 0.85)),
            (128, 255, 128)),  # Purple

            ("Lane5", 
            (int(self.frame_width * 0.80), int(self.frame_height * 0.478)),
            (int(self.frame_width * 0.92), int(self.frame_height * 0.478)),
            (int(self.frame_width * 0.90), int(self.frame_height * 0.50)),
            (int(self.frame_width * 0.99), int(self.frame_height * 0.50)),
            (0, 255, 0)),  # Green

            ("Lane6", 
            (int(self.frame_width * 0.83), int(self.frame_height * 0.50)),
            (int(self.frame_width * 1.00), int(self.frame_height * 0.50)),
            (int(self.frame_width * 0.94), int(self.frame_height * 0.82)),
            (int(self.frame_width * 1.00), int(self.frame_height * 0.82)),
            (0, 255, 128)),    

            ("High_Lane3", 
            (int(self.frame_width * 0.604), int(self.frame_height * 0.478)),
            (int(self.frame_width * 0.79), int(self.frame_height * 0.478)),
            (int(self.frame_width * 0.604), int(self.frame_height * 0.51)),
            (int(self.frame_width * 0.79), int(self.frame_height * 0.51)),
            (128, 0, 128)),  # Purple

            ("High_Lane4", 
            (int(self.frame_width * 0.761), int(self.frame_height * 0.645)),
            (int(self.frame_width * 0.807), int(self.frame_height * 0.645)),
            (int(self.frame_width * 0.761), int(self.frame_height * 0.757)),
            (int(self.frame_width * 0.807), int(self.frame_height * 0.757)),
            (128, 255, 128)),  # Purple

            ("High_Lane5", 
            (int(self.frame_width * 0.80), int(self.frame_height * 0.478)),
            (int(self.frame_width * 0.96), int(self.frame_height * 0.478)),
            (int(self.frame_width * 0.80), int(self.frame_height * 0.50)),
            (int(self.frame_width * 0.96), int(self.frame_height * 0.50)),
            (0, 255, 0)),  # Green

            ("High_Lane6", 
            (int(self.frame_width * 0.86), int(self.frame_height * 0.50)),
            (int(self.frame_width * 0.925), int(self.frame_height * 0.50)),
            (int(self.frame_width * 0.86), int(self.frame_height * 0.595)),
            (int(self.frame_width * 0.925), int(self.frame_height * 0.595)),
            (0, 255, 128)),

            ("Very_High_Lane3", 
            (int(self.frame_width * 0.707), int(self.frame_height * 0.478)),
            (int(self.frame_width * 0.707), int(self.frame_height * 0.478)),
            (int(self.frame_width * 0.721), int(self.frame_height * 0.51)),
            (int(self.frame_width * 0.721), int(self.frame_height * 0.51)),
            (0, 255, 128)),

            ("Very_High_Lane4", 
            (int(self.frame_width * 0.617), int(self.frame_height * 0.598)),
            (int(self.frame_width * 0.68282), int(self.frame_height * 0.598)),
            (int(self.frame_width * 0.617), int(self.frame_height * 0.7594)),
            (int(self.frame_width * 0.68282), int(self.frame_height * 0.7594)),
            (128, 255, 128)),  # Purple
        ]
        return zones
    ...
    def is_in_lane5_zone(self, center, zone):
        x, y = center
        _, tl, tr, bl, br, _ = zone
    ...
    def is_in_lane6_zone(self, center, zone):
        x, y = center
        _, tl, tr, bl, br, _ = zone

        # đơn giản hóa: kiểm tra theo hình chữ nhật nằm ngang
        if tl[0] <= x <= br[0] and tr[1] <= y <= br[1]:
            self.logger.info("6. Lane6")
            return True
        return False
    ...
    def is_in_high_lane5_zone(self, center, zone):
        x, y = center
        _, tl, tr, bl, br, _ = zone

        # đơn giản hóa: kiểm tra theo hình chữ nhật nằm ngang
        if tl[0] <= x <= br[0] and tr[1] <= y <= br[1]:
            self.logger.info("5. High_Lane5")
            return True
        return False

    def is_in_high_lane6_zone(self, center, zone):
        x, y = center
        _, tl, tr, bl, br, _ = zone

        # đơn giản hóa: kiểm tra theo hình chữ nhật nằm ngang
        if tl[0] <= x <= br[0] and tr[1] <= y <= br[1]:
            self.logger.info("6. High_Lane6")
            return True
        return False
    
    def is_in_very_high_lane3_zone(self, center, zone):
        x, y = center
        _, tl, tr, bl, br, _ = zone

        # đơn giản hóa: kiểm tra theo hình chữ nhật nằm ngang
        if tl[0] <= x <= br[0] and tr[1] <= y <= br[1] or ():
            self.logger.info("3. Very_High_Lane3")
            return True
        return False
    
    def is_in_very_high_lane4_zone(self, center, zone):
        x, y = center
        _, tl, tr, bl, br, _ = zone

        # đơn giản hóa: kiểm tra theo hình chữ nhật nằm ngang
        if tl[0] <= x <= br[0] and tr[1] <= y <= br[1]:
            self.logger.info("4. Very_High_Lane4")
            return True
        return False
    ...
    def calculate_filtered_distance_pixels(self, transformed_coords):
        ...
        for i in range(1, 5):
            ...
            if abs(dy) > 6.0:
                dy = abs(dy) - 3.5
            if (abs(dx) <= 0.15 and abs(dy) <= 0.15) or ((abs(dx) + abs(dy)) <= 0.23):
                continue
    ...
    def calculate_speed_MPP(self, coordinates, bbox_list, fps, frame_width, frame_height, mpp, matrix):
        ...
        if self.is_in_lane1_zone(center, self.zones[0]) == True:
            ...
            elif self.is_in_very_high_lane4_zone(center, self.zones[11]) == True:
                mpp = mpp * 0.15
                mpp_scaled = mpp * scale_factor * block_parameter
            else:
                mpp = mpp * 0.34
            ...
            block_parameter = self.adjust_speed_by_position((self.frame_height - center[1]), frame_height, 314.8, 1.3)
            self.logger.info(f"BP: {block_parameter}")
            ...
            if (self.is_in_high_lane3_zone(center, self.zones[6]) == True):
                if (self.is_in_very_high_lane3_zone(center, self.zones[10]) == True):
                    mpp = mpp * 0.41
                else:
                    mpp = mpp * 0.56
                mpp_scaled = mpp * scale_factor * block_parameter
        ...
        elif (self.is_in_lane5_zone(center, self.zones[4]) == True):
            block_parameter = self.adjust_speed_by_position(center[1], frame_height, 52.3, 1.3)
            self.logger.info(f"BP: {block_parameter}")
            ...
            if (self.is_in_high_lane5_zone(center, self.zones[8]) == True):
                mpp = mpp * 0.15
            else:
                mpp = mpp * 2.1
            mpp_scaled = mpp * ratio * scale_factor * block_parameter
        
        elif (self.is_in_lane6_zone(center, self.zones[5]) == True):
            block_parameter = self.adjust_speed_by_position(center[1], frame_height, 5.3)
            self.logger.info(f"BP: {block_parameter}")
            ...
            mpp = 1.25
            scale_factor = real_height / (bbox_height * mpp + 1e-6)  # tránh chia 0
            if (self.is_in_high_lane6_zone(center, self.zones[9]) == True):
                mpp = mpp * 1.5
            else:
                mpp = mpp * 2.01
            mpp_scaled = mpp * ratio * scale_factor * block_parameter
    ...
    def check_zone(self, center):
        if (self.is_in_lane1_zone(center, self.zones[0]) == True) or (self.is_in_lane2_zone(center, self.zones[1]) == True) or (self.is_in_lane3_zone(center, self.zones[2]) == True) or (self.is_in_lane4_zone(center, self.zones[3]) == True) or (self.is_in_lane5_zone(center, self.zones[4]) == True) or (self.is_in_lane6_zone(center, self.zones[5]) == True):
            return True
        else:
            return False
